      ...
      <div className="mx-auto w-full max-w-7xl  py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="space-y-2  md:mb-0">
            ...
            <p className="text-gray-500 dark:text-gray-400 font-medium">
              We Keep Pet For Pleasure
            </p>
            <p className="text-gray-500 dark:text-gray-400 font-medium">
              Helping Your Pets Get Rid of Annoying pets
            </p>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              <h2 className="mb-6 text-sm font-semibold text-base-200 uppercase dark:text-white">
                Resources
              </h2>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            ...
            >
              <FaLinkedinIn />
              <span className="sr-only">Pet Haven community</span>
            </a>
            <a
